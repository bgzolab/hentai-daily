...
## Kungal NSFW Gal [^why_kungal]

```html
https://raw.githubusercontent.com/bgzo/hentai-daily/refs/heads/vitepress/api/feeds/kungal.xml
```
[^why_kungal]: Only NSFW content is fetched.
